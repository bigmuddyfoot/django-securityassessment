...
class Question(models.Model):
    ...
    standardized_inputs = models.ManyToManyField(StandardizedInput, blank=True,
...
class UserAnswer(models.Model):
    ...
    selected_option = models.ForeignKey(QuestionOption, on_delete=models.SET_NULL, blank=True, null=True)
